    ...
    <div className="my-64">
      ...
      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
          <Details
            position={t("experience.itecnoveRole")}
            company="itecnove"
            companyLink="https://www.itecnove.com/"
            time={`15/06/2025 - ${t("experience.present")}`}
            address={t("experience.homeOffice")}
            work={t("experience.itecnoveWork")}
          />
          <Details
            position={t("experience.conectaRole")}
            company="Conecta360"
            companyLink="https://www.conecta360.com.br/"
            time="15/04/2024 - 26/06/2025"
            address={t("experience.homeOffice")}
            work={t("experience.conectaWork")}
          />
        </ul>
      </div>
    </div>
